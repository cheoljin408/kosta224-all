...
public class MemberServiceImpl implements MemberService {
	 ...
	 * 등록작업은 세부적으로 회원 일반정보 등록과 포인트 일반정보 등록으로 구성된다 
	 ...
	 *  				컨트롤러에서 Spring Container로부터 MemberServiceImpl객체가 아닌
	 *  				AOP Proxy 객체가 DI 되어 해당 메소드에서 문제 발생시 rollback
	 *  				정상적으로 수행되면 commit 되도록 한다
	 */
	@Override
	@Transactional
