package solution.test.step3;

import solution.model.Employee;
import solution.model.SchoolService;
import solution.model.Student;
import solution.model.Teacher;
...
public class TestCaseDelete {
	public static void main(String[] args) {
		...
		System.out.println("삭제:" + service.deleteMemberByTel(tel));// tel:0101231237 name:김근원 address:화성 department:재무부
