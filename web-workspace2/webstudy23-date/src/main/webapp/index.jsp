...
<%--
		컨트롤러 영역 테스트를 위한 폼
					 ...
					 @WebSerlvet("*.do")
		index.jsp -- FrontControllerServlet -- HanslerMapping -- Controller
																	|
																TestController
						| forward
					test-result.jsp
...
<%--
		index.jsp -- FrontControllerServlet -- HanslerMapping -- FindProductByIdController -- ProductDAO ------------------Database
