...
public class TestSpringMyBatis {
	public static void main(String[] args) {
		...
		/*
		 * AccountDAO dao = (AccountDAO)ctx.getBean("accountDAOImpl"); // String id =
		 * "1"; // System.out.println(dao.findAccountById(id));
		 * 
		 * dao.registerAccount(new AccountVO("3", "손흥민", 2000));
		 * 
		 * List<AccountVO> list = dao.getAllAccountList(); for(AccountVO vo:list) {
...
//		}
		...
		// 5. 회원정보 수정
//		System.out.println("수정 전: " + memberDAO.findMemberById("spring"));
//		MemberVO vo = new MemberVO("spring", "b", "이강인", "판교");
//		memberDAO.updateMember(vo);
//		System.out.println("수정 후: " + memberDAO.findMemberById("spring"));

		// 6. 회원정보 삭제
//		System.out.println("삭제 전: " + memberDAO.findMemberById("spring"));
		// template.delete()를 이용
//		String id = "spring";
//		memberDAO.deleteMemberById(id);
//		System.out.println("삭제 후: " + memberDAO.findMemberById("spring"));
		
		// 7. 회원아이디로 조회한 회원정보를 Map으로 반환
		String id = "java";
