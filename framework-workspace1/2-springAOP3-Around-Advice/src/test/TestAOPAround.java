 ...
 * : Around Advice는 before, after, after-returning, after-throwing의 4가지 advice를 모두 적용할 수 있는 advice
 */
public class TestAOPAround {
	public static void main(String[] args) {
		...
		// 이전 예제와 다르게 core가 interface를 implements하지 않으므로 상속을 통한 proxy를 spring container가 반환
