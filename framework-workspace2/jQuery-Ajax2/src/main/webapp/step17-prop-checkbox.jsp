...
<script type="text/javascript">
	$(function() {
		// allCheck 체크박스의 체크상태와 menu 체크박스들의 체크 상태를 일치시킨다
		// allCheck 체크박스를 체크하면 menu 체크박스들이 모두 체크되고, 체크 해제하면 모두 체크해제된다
		$("#allCheck").change(function() {
			// alert($(this).prop("checked"));
			
			// id가 menuForm인 checkbox중 menu name의 checkbox들을 select 해서 모두 prop("checked", allCheck의 체크상태);
